...
MODEL_PATH = attach_home_root('model/HiNetUnet_ResidualDenseBlock_out_v2/')
os.makedirs(MODEL_PATH, exist_ok=True)

IMAGE_PATH = attach_home_root('show/HiNetUnet_ResidualDenseBlock_out_v2/')
...
cropsize = 512
model_config = dict(shared_rev_blocks=False, subnet_constructor="ResidualDenseBlock_out_v2",
                    num_inv_blocks_lt=(6, 6, 6, 6))